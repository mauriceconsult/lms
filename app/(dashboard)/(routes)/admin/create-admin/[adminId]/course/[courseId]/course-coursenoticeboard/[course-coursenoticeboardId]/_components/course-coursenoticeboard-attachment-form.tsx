...
interface CourseCourseNoticeboardAttachmentFormProps {
  initialData: CourseNoticeboard & { attachments: Attachment[] };
  facultyId: string;
  courseId: string;
...
export const CourseCourseNoticeboardAttachmentForm = ({
  initialData,
  facultyId,
  courseId,
  courseCourseNoticeboardId,
}: CourseCourseNoticeboardAttachmentFormProps) => {
      ...
      {isEditing && (
        <div>
          ...
          <div className="text-xs text-muted-foreground mt-4">
            Add resources to aid your communications.
          </div>
        </div>
      )}
    </div>
