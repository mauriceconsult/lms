...
export const AssignmentActions = ({
  ...
  const onClick = async () => {
    try {
      ...
      if (isPublished) {
        await axios.patch(
          `/api/create-admins/${adminId}/courses/${courseId}/tutorials/${tutorialId}/assignments/${assignmentId}/unpublish`
        );
        toast.success("Assignment unpublished");
      } else {
        await axios.patch(
          `/api/create-admins/${adminId}/courses/${courseId}/tutorials/${tutorialId}/assignments/${assignmentId}/publish`
        );
