...
interface PayrollAdminFormProps {
  initialData: {
  ...
  return (
    <div className="space-y-4">
      <div className="text-sm text-slate-700">
        Add and manage courses for this Payroll Direct. At least one published
        course is required to publish the Payroll Direct.
      </div>
