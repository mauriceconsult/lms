...
export const CourseworkStudentProjectForm = ({
  initialData,
  facultyId,
  courseworkId,
}: CourseworkStudentProjectFormProps) => {
  ...
  const onReorder = async (updateData: { id: string; position: number }[]) => {
    try {
      setIsUpdating(true);
      await axios.put(`/api/create-faculties/${facultyId}/courseworks/${courseworkId}/studentProjects/reorder`, {
        list: updateData,
      });
